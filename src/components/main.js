    ...
    <main>
      <section class="section-hero">
        <div class="hero">
          ...
          <div class="hero-img-box">
            <picture>
              <source srcset={require("./img/hero.webp")} type="image/webp" />
              <source srcset={require("./img/hero-min.png")} type="image/png" />
              <img
                src={require("./img/hero-min.png")}
                class="hero-img"
      ...
      <section class="section-testimonials" id="testimonials">
        <div class="testimomial-container">
          ...
          <h2 class="heading-secondary">Once you try it you will go back</h2>
